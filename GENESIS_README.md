...
`solslot-v2-alpha-rc27.36-20260824` on
`release/testnet-alpha-rc27.36-20260824`. The browser cannot choose its review
...
- guided launch configuration names the exact RC27.36 tag, source-evidence
