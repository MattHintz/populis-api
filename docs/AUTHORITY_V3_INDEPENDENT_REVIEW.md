...
`solslot-v2-alpha-rc27.36-20260824` after all nine final commits are on
`main`, `release/testnet-alpha-rc27.36-20260824`, and the annotated release
tag. RC27.32 review notes remain historical evidence and cannot approve a
changed RC27.36 source scope.
